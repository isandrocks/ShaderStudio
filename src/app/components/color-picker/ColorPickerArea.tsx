...
export const ColorPickerArea: React.FC<ColorPickerAreaProps> = ({ hsv, onHsvChange }) => {
  ...
  const currentColorStr = rgbToCssString(currentColor.r, currentColor.g, currentColor.b);
  ...
  return (
    <div 
      ref={areaRef}
      className="relative w-full aspect-square mb-3 rounded-sm overflow-hidden select-none"
      style={{
        background: `
    ...
    >
      {/* Thumb */}
      <div
        className="absolute w-4 h-4 rounded-full border-4 border-white shadow-[0_0_0.5px_rgba(0,0,0,0.18),0_3px_8px_rgba(0,0,0,0.1),0_1px_3px_rgba(0,0,0,0.1)]
          pointer-events-none"
        style={{
          left: `${hsv.s}%`,
          top: `${100 - hsv.v}%`,
